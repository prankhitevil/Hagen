...
Кнопка в «Настройки → Продвинутые» ставит свежий, не заставляя лезть
в командную строку.
...
Что проверяем:
  ...
  5. кнопка и подпись на вкладке «Продвинутые» подключены.
...
check("кнопка «Обновить yt-dlp» на вкладке «Продвинутые»",
