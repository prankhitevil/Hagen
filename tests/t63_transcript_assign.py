...
check("в подсказке сказано про Enter", "<b>Enter</b>" in html and "другому голосу" in html)
check("место для списка голосов есть", 'id="give-menu"' in html and ".give-menu" in css)
