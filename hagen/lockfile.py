...
Архив выпуска несёт только код, Python и модели разметки и поиска речи.
Остальное — библиотеки (onnxruntime, yt-dlp и прочие), ffmpeg, модели распознавания — установщик
